...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-24">
            ...
            <!-- Navigation Links -->
            <nav class="p-2">
                <a href="/admin" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 hover:text-primary-600 rounded-lg mb-1 transition-colors">
                    <i class="fas fa-tachometer-alt w-5 h-5 mr-3"></i>
                    Dashboard
                </a>
                <a href="/admin/users" class="flex items-center px-4 py-3 text-gray-700 bg-primary-50 border-r-4 border-primary-500 rounded-lg mb-1 font-medium">
                    <i class="fas fa-users w-5 h-5 mr-3 text-primary-500"></i>
                    Kullanıcılar
                </a>
